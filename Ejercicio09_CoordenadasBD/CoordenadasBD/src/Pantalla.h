...
// los cinco metodos virtuales puros. El flujo de la aplicacion (Coordinador)
// trabaja contra punteros a Pantalla, garantizando el uso de polimorfismo.
class Pantalla {
public:
    ...
    // Carga datos iniciales (config, base de datos, recursos).
